...
VALUES
  (
    ...
    'Preset untuk kompetisi tingkat fakultas atau universitas.',
    'Internal UB',
    true
  ),
  (
    ...
    'regional',
    'Regional / Provinsi',
    'Preset untuk kompetisi tingkat kota, wilayah, atau provinsi.',
    'Regional',
    true
  ),
  (
    ...
    'nasional',
    'Nasional',
    'Preset siap pakai untuk kompetisi tingkat nasional.',
    'Nasional',
    true
  ),
  (
    ...
    'internasional',
    'Internasional',
    'Preset siap pakai untuk kompetisi tingkat internasional.',
    'Internasional',
    true
  ),
  (
  ...
  (
    ...
    'umum',
    'Umum / Kustom',
    'Titik awal netral yang dapat diubah sepenuhnya untuk kompetisi lain.',
    'Umum',
    true
  );
...
VALUES
  ...
  ('00000000-0000-4000-8000-000000000501', 'Juara 2', 16, 20),
  ('00000000-0000-4000-8000-000000000501', 'Juara 3', 13, 30),
  ('00000000-0000-4000-8000-000000000501', 'Juara Harapan', 10, 40),
  ('00000000-0000-4000-8000-000000000501', 'Finalis', 7, 50),
  ('00000000-0000-4000-8000-000000000501', 'Peserta', 3, 60),

  ('00000000-0000-4000-8000-000000000502', 'Juara 1', 30, 10),
  ('00000000-0000-4000-8000-000000000502', 'Juara 2', 24, 20),
  ('00000000-0000-4000-8000-000000000502', 'Juara 3', 20, 30),
  ('00000000-0000-4000-8000-000000000502', 'Juara Harapan', 15, 40),
  ('00000000-0000-4000-8000-000000000502', 'Finalis', 10, 50),
  ('00000000-0000-4000-8000-000000000502', 'Peserta', 5, 60),

  ('00000000-0000-4000-8000-000000000503', 'Juara 1', 50, 10),
  ('00000000-0000-4000-8000-000000000503', 'Juara 2', 40, 20),
  ('00000000-0000-4000-8000-000000000503', 'Juara 3', 32, 30),
  ('00000000-0000-4000-8000-000000000503', 'Juara Harapan', 25, 40),
  ('00000000-0000-4000-8000-000000000503', 'Finalis', 18, 50),
  ('00000000-0000-4000-8000-000000000503', 'Peserta', 8, 60),

  ('00000000-0000-4000-8000-000000000504', 'Juara 1', 75, 10),
  ('00000000-0000-4000-8000-000000000504', 'Juara 2', 60, 20),
  ('00000000-0000-4000-8000-000000000504', 'Juara 3', 48, 30),
  ('00000000-0000-4000-8000-000000000504', 'Honorable Mention / Harapan', 38, 40),
  ('00000000-0000-4000-8000-000000000504', 'Finalis', 28, 50),
  ('00000000-0000-4000-8000-000000000504', 'Peserta', 12, 60),
  ...
  ('00000000-0000-4000-8000-000000000506', 'Juara 2', 24, 20),
  ('00000000-0000-4000-8000-000000000506', 'Juara 3', 18, 30),
  ('00000000-0000-4000-8000-000000000506', 'Finalis', 12, 40),
  ('00000000-0000-4000-8000-000000000506', 'Peserta', 5, 50);
